  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section className="justify-center items-center w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-black text-white bg-gradient-to-tr from-slate-900 via-sky-700 to-blue-700">
